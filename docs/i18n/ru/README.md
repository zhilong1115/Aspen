...
**Официальный Twitter:** [@atrade_ai](https://x.com/atrade_ai)
...
**По вопросам партнерства и сотрудничества**, пишите в DM нашего официального Twitter [@atrade_ai](https://x.com/atrade_ai).
...
**💬 [Сообщество разработчиков ATrade](https://t.me/atrade_dev_community)**
...
ATrade теперь поддерживает **три основные биржи**: Binance, Hyperliquid и Aster DEX!
...
Миссия ATrade - стать **Универсальной AI Торговой Операционной Системой** для всех финансовых рынков.
...
ATrade построен на современной модульной архитектуре:
...
**ATrade также поддерживает Hyperliquid** - децентрализованную биржу бессрочных фьючерсов. Чтобы использовать Hyperliquid вместо Binance:
...
**ATrade также поддерживает Aster DEX** - децентрализованную биржу бессрочных фьючерсов, совместимую с Binance!
...
- **GitHub Issues**: [Создать Issue](https://github.com/tinkle-community/atrade/issues)

...
**Официальный Twitter:** [@aspen_ai](https://x.com/aspen_ai)
...
**По вопросам партнерства и сотрудничества**, пишите в DM нашего официального Twitter [@aspen_ai](https://x.com/aspen_ai).
...
**💬 [Сообщество разработчиков Aspen](https://t.me/aspen_dev_community)**
...
Aspen теперь поддерживает **три основные биржи**: Binance, Hyperliquid и Aster DEX!
...
Миссия Aspen - стать **Универсальной AI Торговой Операционной Системой** для всех финансовых рынков.
...
Aspen построен на современной модульной архитектуре:
...
**Aspen также поддерживает Hyperliquid** - децентрализованную биржу бессрочных фьючерсов. Чтобы использовать Hyperliquid вместо Binance:
...
**Aspen также поддерживает Aster DEX** - децентрализованную биржу бессрочных фьючерсов, совместимую с Binance!

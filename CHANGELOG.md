...
All notable changes to the Aspen project will be documented in this file.
...
This is a **major breaking update** that completely transforms Aspen from a static config-based system to a modern web-based trading platform.
...
- [GitHub Repository](https://github.com/zhilong1115/Aspen)

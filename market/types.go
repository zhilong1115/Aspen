...
type Data struct {
	...
	SSLLowerK             float64
	ZeroLagTrend          int
	ZeroLagZLEMA          float64
	ZeroLagVolatility     float64
	QQETrend              int
	QQEFastTL             float64
	QQEUpper              float64
	QQELower              float64
	...
	DPSDPerDown           float64
	UltimateRSI           float64
	UltimateRSISignal     float64
	UltimateRSIOverbought bool
	UltimateRSIOversold   bool
	RSIBuySignal          bool
	RSISellSignal         bool
	RSIValue              float64
	TSI4hValue            float64
